...
namespace MyPersonalBlog.Controllers
{
    public class TagsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TagId,PostId,AuthorId,Text")] Tag tag)
        {
            ...
            ViewData["PostId"] = new SelectList(_context.Posts, "PostId", "Abstract", tag.PostId);
            return View(tag);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TagId,PostId,AuthorId,Text")] Tag tag)
        {
            if (id != tag.TagId)
            {
                return NotFound();
